...
4. Prevent discovery-first EDA from being overwritten by demo / presentation / app patterns
5. Preserve basic marimo semantics: visible final outputs, unique exported names, downstream widget `.value`, and no downstream reads of `_` temporaries
